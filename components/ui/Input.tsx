  ...
  return (
    <div className="flex items-center  w-full justify-center">
      <div className="relative w-full">
        <input
          {...props}
          className={cn("peer border-b border-gray-300 bg-inherit py-1 transition-colors focus:border-b-2 focus:border-blue-700 focus:outline-none", props.className)}
          placeholder=" "
        />
        <label
          htmlFor={props.id}
